...
export function OwlesterAuthBackground() {
  return (
    <div aria-hidden className="owlester-auth-background">
      <div className="owlester-glow owlester-glow-purple" />
      <div className="owlester-glow owlester-glow-teal" />
      <div className="owlester-glow owlester-glow-orange" />
      ...
      <svg className="owlester-orbit owlester-orbit-left" viewBox="0 0 520 520">
        ...
        <circle cx="260" cy="260" r="180" stroke="#ff6b35" strokeWidth="1.5" fill="none" />
        <circle cx="260" cy="260" r="120" stroke="#fff" strokeWidth="1" fill="none" strokeDasharray="4 10" />
        <circle cx="260" cy="260" r="60" stroke="#e91e8c" strokeWidth="1.5" fill="none" />
        <circle cx="260" cy="40" r="6" fill="#ff6b35" />
        <circle cx="440" cy="260" r="4" fill="#e91e8c" />
